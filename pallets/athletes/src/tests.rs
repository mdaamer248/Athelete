...
use crate::{
  mock::{alice, bob, test_ext, Athletes, Balances, Extrinsic, Origin, Runtime, TestAuth},
  Call, Error, OffchainPayload, ORACLE_URL,
};
use alloc::sync::Arc;
use frame_support::assert_noop;
use frame_system::offchain::{SignedPayload, SigningTypes};
use meta_athlete_primitives::{Athlete, AthleteCardAttributes, AthleteCardClass};
